...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      <div className="mb-8">
        <h1 className="text-3xl font-bold font-heading mb-2 text-slate-900 dark:text-white">Create an account</h1>
        <p className="text-slate-500 dark:text-slate-400">
          Get started with Ease Your Needs and book your perfect event in minutes.
        </p>
      </div>
      ...
      <form onSubmit={handleRegister} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-slate-500 pl-1">Min. 6 characters</p>
        </div>

        <button
          type="submit"
          disabled={isSubmitting || !formData.email || !formData.name || !formData.password}
          className="w-full mt-4 flex items-center justify-center gap-2 py-3 px-4 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-medium rounded-xl transition-all active:scale-[0.98] shadow-lg shadow-blue-500/25"
        >
          {isSubmitting ? (
      ...
      {/* Divider */}
      <div className="mt-6 flex items-center gap-4 before:flex-1 before:h-px before:bg-slate-200 dark:before:bg-slate-800 after:flex-1 after:h-px after:bg-slate-200 dark:after:bg-slate-800">
